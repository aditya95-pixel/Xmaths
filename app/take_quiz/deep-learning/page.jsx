...
function MCQPage() {
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      setLoading(true);
      try {
        const mcqRes = await fetch(`/api/mcqs?subject=Deep Learning`);
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        {quizState === 'idle' && (
          <>
            ...
            >
              <h1 className="text-5xl font-extrabold text-slate-900 dark:text-white mb-4 tracking-tight">Deep Learning Quiz</h1>
        ...
        {quizState === 'completed' && (
          ...
          >
            ...
            <p className="text-slate-500 dark:text-gray-400 mb-8">Great job on finishing the Deep Learning module.</p>
