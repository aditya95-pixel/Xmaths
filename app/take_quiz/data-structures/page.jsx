...
function MCQPage() {
  ...
  useEffect(() => {
    const fetchInitialData = async () => {
      setLoading(true);
      try {
        const mcqRes = await fetch(`/api/mcqs?subject=Data Structures`);
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        {quizState === 'idle' && (
          <>
            ...
            >
              <h1 className="text-5xl font-extrabold text-slate-900 dark:text-white mb-4 tracking-tight">Data Structures Quiz</h1>
