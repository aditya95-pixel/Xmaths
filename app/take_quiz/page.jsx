    ...
    <div className="min-h-screen p-8 ml-0 md:ml-20 dark:bg-[#171717] bg-gray-50 transition-all">
      <div className="max-w-6xl mx-auto">
        <header className="mb-12">
          <h1 className="text-4xl font-bold dark:text-white text-gray-800">Take A quiz</h1>
          <p className="mt-2 text-gray-500 dark:text-gray-400">Select a module to assess yourself.</p>
        </header>
