...
const Message = ({role,content}) => {
  ...
  return (
    <div className='flex flex-col items-center w-full max-w-6xl text-base print:break-inside-avoid print:mb-8'>
        <div className={`flex flex-col w-full mb-8 ${role==='user' && 'items-end'}`}>
            <div className={`group relative flex max-w-full py-3 rounded-xl
                ${role==='user' ? 'dark:bg-[#414158] bg-gray-300 px-5' : 'gap-3'}`}>
                    <div className={`opacity-0 group-hover:opacity-100 no-print absolute
                    ...
                    { 
                        ...
                        (
                            <>
                                ...
                                <div className='space-y-4 w-full overflow-x-auto print:overflow-visible'>
